...
public class ContactCreationTests {
  ...
  public void testContactCreation() {
    gotoAddContact();
    fillConatctForm(new ContactDate("Arsen", "Wenger", "Ars", "Arsenal", "London", "Manager", "arsen_wenger@gmail.com", "+78304458345435", "1950", "England London", "4 space", "Emirets"));
    clickButtonAddContact();
  }

  private void clickButtonAddContact() {
    wd.findElement(By.xpath("//div[@id='content']/form/input[21]")).click();
  }

  private void fillConatctForm(ContactDate contactDate) {
    ...
    wd.findElement(By.name("byear")).sendKeys(contactDate.getByEar());
    wd.findElement(By.name("address2")).click();
    wd.findElement(By.name("address2")).clear();
    wd.findElement(By.name("address2")).sendKeys(contactDate.getAddress2());
    wd.findElement(By.name("notes")).click();
    wd.findElement(By.name("notes")).clear();
    wd.findElement(By.name("notes")).sendKeys(contactDate.getNotes());
    wd.findElement(By.name("phone2")).click();
    wd.findElement(By.name("phone2")).clear();
    wd.findElement(By.name("phone2")).sendKeys(contactDate.getPhone2());
  }
